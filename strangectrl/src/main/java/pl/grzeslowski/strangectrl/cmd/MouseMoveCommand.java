...
public abstract class MouseMoveCommand extends AnalogCommand implements ICommand {
    ...
    public MouseMoveCommand(final InputUtils inputUtils, final int maxMove, final double delta, final DesktopUtils desktopUtils) {
        super(inputUtils, maxMove, delta);
        this.desktopUtils = checkNotNull(desktopUtils);
    }

    public MouseMoveCommand(final InputUtils inputUtils, final int maxMove, final DesktopUtils desktopUtils) {
